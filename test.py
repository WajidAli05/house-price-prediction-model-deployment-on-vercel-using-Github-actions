...
class TestHousePriceModel(unittest.TestCase):
    ...
    def test_preprocessing(self):
        ...
        sample_input = [5000, 4, 3, 2, 'yes', 'no', 'no', 'no', 'yes', 2, 'yes', 'furnished']
        ...
        categorical_values = [sample_input[4], sample_input[5], sample_input[6], sample_input[7], sample_input[8], sample_input[10], sample_input[11]]
        numerical_values = [sample_input[0], sample_input[1], sample_input[2], sample_input[3], sample_input[9]]
        ...
        self.assertEqual(encoded_categorical_values.shape[1], len(encoder.get_feature_names_out(categorical_columns)),
                         "Unexpected number of categorical encoded features")
        self.assertEqual(scaled_numerical_values.shape[1], len(numerical_columns),
    ...
    def test_model_persistence(self):
        ...
        self.assertTrue(os.path.exists(self.model_path), "Model was not saved correctly")
        self.assertTrue(os.path.exists(self.scaler_path), "Scaler was not saved correctly")
        self.assertTrue(os.path.exists(self.encoder_path), "Encoder was not saved correctly")
